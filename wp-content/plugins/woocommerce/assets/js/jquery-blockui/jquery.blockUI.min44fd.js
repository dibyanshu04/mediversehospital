  ...
  function e(b) {
    ...
    var p = b.noop || function () {},
      ...
      y =
        ...
        b.isFunction(document.createElement("div").style.setExpression));
    (b.blockUI = function (e) {
      ...
      (b.fn.block = function (e) {
        ...
        return (
          ...
          this.each(function () {
            "static" == b.css(this, "position") &&
              ((this.style.position = "relative"),
              b(this).data("blockUI.static", !0)),
              (this.style.zoom = 1),
              o(this, e);
          })
        );
    ...
    function o(e, o) {
      ...
      ((o = b.extend({}, b.blockUI.defaults, o || {})).ignoreIfBlocked &&
        b(e).data("blockUI.isBlocked")) ||
        ((o.overlayCSS = b.extend(
          {},
          b.blockUI.defaults.overlayCSS,
          o.overlayCSS || {}
        )),
        ...
        f &&
          ...
          ((t = f.jquery ? f[0] : f),
          (a = {}),
          b(e).data("blockUI.history", a),
          (a.el = t),
          (a.parent = t.parentNode),
          (a.display = t.style.display),
          (a.position = t.style.position),
          a.parent && a.parent.removeChild(t)),
        ...
        o.theme &&
          o.draggable &&
          b.fn.draggable &&
          r.draggable({ handle: ".ui-dialog-titlebar", cancel: "li" }),
        (s =
          y &&
          (!b.support.boxModel || 0 < b("object,embed", u ? null : e).length)),
        (k || s) &&
          (u &&
            o.allowBodyStretch &&
            b.support.boxModel &&
            b("html,body").css("height", "100%"),
          (!k && b.support.boxModel) ||
            u ||
            ((i = U(e, "borderTopWidth")),
            (s = U(e, "borderLeftWidth")),
            (l = i ? "(0 - " + i + ")" : 0),
            (d = s ? "(0 - " + s + ")" : 0)),
              ...
              e < 2
                ...
                : !o.centerY &&
                  ...
                  ((e =
                    ...
                    (o.css && o.css.top ? parseInt(o.css.top, 10) : 0) +
                    ') + "px"'),
                  t.setExpression("top", e));
          })),
        f &&
          ((o.theme ? r.find(".ui-widget-content") : r).append(f),
          (f.jquery || f.nodeType) && b(f).show()),
        (h || o.forceIframe) && o.showOverlay && a.show(),
        o.fadeIn
          ? ((c = o.onBlock ? o.onBlock : p),
            (a = o.showOverlay && !f ? c : p),
            (c = f ? c : p),
            o.showOverlay && t._fadeIn(o.fadeIn, a),
            f && r._fadeIn(o.fadeIn, c))
          : (o.showOverlay && t.show(),
            f && r.show(),
            o.onBlock && o.onBlock.bind(r)()),
        I(1, e, o),
        u
          ? ((m = r[0]),
            (g = b(o.focusableElements, m)),
            o.focusInput && setTimeout(w, 20))
          : (function (e, t, o) {
              var n = e.parentNode,
                i = e.style,
                s =
                  (n.offsetWidth - e.offsetWidth) / 2 - U(n, "borderLeftWidth"),
                n =
    ...
    function I(e, t, o) {
      ...
      (!e && ((n && !m) || (!n && !t.data("blockUI.isBlocked")))) ||
        ...
        n &&
          ...
          e ? b(document).bind(n, o, i) : b(document).unbind(n, i)));
    }
    function i(e) {
      if (
        "keydown" === e.type &&
      ...
      var n = e.data,
        t = b(e.target);
      return (
        t.hasClass("blockOverlay") && n.onOverlayClick && n.onOverlayClick(e),
        0 < t.parents("div." + n.blockMsgClass).length ||
          0 === t.parents().children().filter("div.blockUI").length
      );
    }
    function w(e) {
