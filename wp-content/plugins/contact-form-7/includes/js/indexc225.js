        ...
        return d.reduceRight(
          ...
          function (e) {
            ...
            "string" == typeof i &&
              ...
              (a = (r = i.replace(/^\//, "")) ? t + "/" + r : t)),
              "string" == typeof a &&
                (-1 !== n.indexOf("?") && (a = a.replace("?", "&")),
                (a = a.replace(/^\//, "")),
                (c = n + a)),
              delete (s = l({ Accept: "application/json, */*;q=0.1" }, s))[
                "X-WP-Nonce"
              ],
              p &&
                ((f = JSON.stringify(p)),
      ...
      p({
        ...
        .then(function (t) {
          ...
          return (
            ...
            ["invalid", "unaccepted", "spam", "aborted"].includes(n)
              ? i(e, n, r)
              : ["sent", "failed"].includes(n) && i(e, "mail".concat(n), r),
            i(e, "submit", r),
            t
          );
        })
        .then(function (t) {
          t.posted_data_hash &&
            ...
            t.invalid_fields &&
              (t.invalid_fields.forEach(o), t.invalid_fields.forEach(c)),
            e.wpcf7.parent
