  ...
  (a.fn.gMap = function (b, c) {
    ...
    return this.each(function () {
        ...
        ? d.markers[0].address
          ...
          : b.setCenter(
              new google.maps.LatLng(
                d.markers[0].latitude,
                d.markers[0].longitude
              )
            )
      ...
      d.controls === !1
        ...
        : 0 !== d.controls.length &&
          a.extend(e, d.controls, { disableDefaultUI: !0 }),
        b.setOptions(e);
      var f,
        g,
      ...
      (f = new google.maps.MarkerImage(d.icon.image)),
        ...
        (f.anchor = new google.maps.Point(
          d.icon.iconanchor[0],
          d.icon.iconanchor[1]
        )),
        h.setIcon(f),
        d.icon.shadow &&
          ...
          (g.size = new google.maps.Size(
            d.icon.shadowsize[0],
            d.icon.shadowsize[1]
          )),
          (g.anchor = new google.maps.Point(
            d.icon.shadowanchor[0],
            d.icon.shadowanchor[1]
          )),
          h.setShadow(g)),
        ...
        if (
          (g
            ? ((l = new google.maps.MarkerImage(g.image)),
              ...
              (l.anchor = new google.maps.Point(
                g.iconanchor[0],
                g.iconanchor[1]
              )),
              o.setIcon(l),
              g.shadow &&
                ((m = new google.maps.MarkerImage(g.shadow)),
                (m.size = new google.maps.Size(
                  g.shadowsize[0],
                  g.shadowsize[1]
                )),
                (m.anchor = new google.maps.Point(
                  g.shadowanchor[0],
                  g.shadowanchor[1]
                )),
                h.setShadow(m)))
      ...
      for (
            ...
            return function (c) {
              c &&
                ...
                a(l).trigger("gMap.addMarker", [
                  c[0].geometry.location.lat(),
                  c[0].geometry.location.lng(),
                  b.html,
                  b.icon,
                  b.popup,
                ]);
        ...
        (k = d.markers[n]),
          k.address
            ? ("_address" === k.html && (k.html = k.address),
              c.geocode({ address: k.address }, m(k)))
            : a(this).trigger("gMap.addMarker", [
                k.latitude,
                k.longitude,
                k.html,
                k.icon,
