...
jQuery(document).ready(function () {
                ...
                el.easyPieChart({
                  ...
                  barColor: function () {
                    return $(this.el).data("bar-color")
                      ...
                      : cmsmasters_script.primary_color;
                  },
  ...
  (function ($) {
    $(".search_wrap .search_button button").on("click", function () {
      ...
      if (searchWrap.hasClass("search_opened")) {
        ...
        setTimeout(function () {
          searchButton
            .addClass("cmsmasters_theme_icon_search")
            .attr("type", "submit");
        }, 300);
      } else {
        ...
        setTimeout(function () {
          searchButton
            .addClass("cmsmasters_theme_icon_cancel")
            .attr("type", "button");
        }, 300);
  ...
  (function ($) {
    $(
      ".cmsmasters_woo_tabs > .cmsmasters_tabs_list > .cmsmasters_tabs_list_item:first-child"
    ).addClass("current_tab");
    $(
      ".cmsmasters_woo_tabs > .cmsmasters_tabs_wrap > .cmsmasters_tab:first-child"
    ).addClass("active_tab");
